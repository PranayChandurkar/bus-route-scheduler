  ...
  return (
    <div className="relative w-full flex flex-col items-center">
      ...
      >
        ...
        <h1 className="text-5xl md:text-7xl font-extrabold premium-gradient-text drop-shadow-sm mb-6 pb-2">
          City Bus Timetable
        </h1>
      ...
      <motion.div
        ...
        className="mt-12 w-full max-w-4xl glass-panel p-6 md:p-8"
      >
        <div className="mb-2">
